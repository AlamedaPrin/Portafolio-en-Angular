...
export class EducacionComponent implements OnInit {
  ...
  guardarEducacion(){
    ...
    if (this.formEducacion.valid){
      ...
      this.datosEducacionPorfolio.editarDatosEducacion(educacionEditar).subscribe( data => {
  ...
  mostrarDatosEducacion() {
    this.formEducacion.controls["descripcion1"].setValue(this.miPorfolioEdu.descripcion1);
    this.formEducacion.controls["descripcion2"].setValue(this.miPorfolioEdu.descripcion2);
  }
